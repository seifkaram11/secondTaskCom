...
android {
    namespace = "com.example.secondtaskforcompose"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.example.secondtaskforcompose"
        minSdk = 27
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    dependencies {
        ...
        // OR
        implementation(libs.androidx.material) // For Material 2
    }

    //for image sent a string
    dependencies {
